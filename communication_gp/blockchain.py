...
class Blockchain(object):
    ...
    def create_genesis_block(self):
        # Typically hard code first block
        # This block must be identical for all nodes or consensus will fail
        block = {
            'index': 1,        # Some start at 0
            'timestamp': 0,
            'transactions': 0,
            'proof': 99,
            'previous_hash': 1
    ...
    def broadcast_new_block(self, block):
        # alert neighbors in list of nodes that a new block has been mined and added to chain
        ...
        for node in self.nodes:
            ...
            if response.status_code ~= 200:
                # TODO: error handling
                print("Broadcast_new_block error")
...
def new_block():
    ...
    # Make sure that index is == last_chain++
